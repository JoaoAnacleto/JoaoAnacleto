...
| **Automação/RPA** | Playwright, Selenium, BotCity, Power Automate |
| **DevOps/Infra** | Docker, Docker Swarm, Portainer, Gost (Proxying) |
| **Cloud/IA** | Azure, OpenAI API, SharePoint Integration |
